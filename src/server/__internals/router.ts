...
import type { Variables, MiddlewareHandler } from 'hono/types';
...
import type { QueryOperation, MutationOperation } from './types';
...
export const router = <T extends Record<string, OperationType<any, any>>>(obj: T) => {
  ...
  type InferInput<U> = U extends OperationType<infer I, any> ? I : {};
  type InferOutput<U> = U extends OperationType<any, infer I> ? I : {};
